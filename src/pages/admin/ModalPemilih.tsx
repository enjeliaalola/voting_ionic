...
const ModalPemilih: React.FC<ModalSheetProps> = ({ isOpen, onClose, data }) => {
  ...
  const { id, nama, nisn, username, password, kelas, gambar } = formData;
  ...
  const simpanData = () => {
    ...
    axios
      .post('https://evotingosis.musky.site/simpanPemilih.php', formData, config)
      .then((response) => {
		  let a = response.data;
